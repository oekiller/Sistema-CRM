	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTAS EL BUNKER DE LA TECNOLOGIA</span>
					<p>Centro Comercial Pasarela Local 162-169 Santiago de Cali </p>
					<p>Teléfono: 3146167402</p>
					<p>Email: bunker_de_la_tecnologia@gmail.com</p>
				</div>
			</td>
