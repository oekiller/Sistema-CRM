    ...
    if(!empty($_POST)){
        ...
        if(empty($_POST['proveedor']) || empty($_POST['producto']) || empty($_POST['precio']) || empty($_POST['id']) || empty($_POST['foto_actual']) || empty($_POST['foto_remove'])){
            ...
            if($query_update){
                ...
                $alert='<p class="msg_save">EL PRODUCTO ACTULIZADO EXITOSAMENTE.</p>';
            }else{
                $alert='<p class="msg_error">ERROR AL ACTULIZAR EL PRODUCTO.</p>';
            }
        }
    }
...
<body>
	...
	<section id="container">
		...
		<div class="form_register">
		    <h1 style="font-size:30px"> <i class="fab fa-product-hunt"></i> ACTUALIZAR PRODUCTO</h1>
		    <hr>
